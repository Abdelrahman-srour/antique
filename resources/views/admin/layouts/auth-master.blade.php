...
<head>
    ...
    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('build/assets/images/favicon.ico') }}" />
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('build/assets/images/favicon.ico') }}" />
