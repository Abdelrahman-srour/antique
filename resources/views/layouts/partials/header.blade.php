            ...
            <div class="outer-container">
                <div class="clearfix">
                    ...
                    <div class="logo"><a href="{{ '/' }}"><img style="height: 100px;width:100%"
                        src="{{ asset('build/assets/images/logo.png') }}" alt="logo" title="logo"></a>
                    </div>
                </div>
                <div class="nav-outer clearfix">
                        ...
                        <ul class="navigation clearfix">
                                ...
                                @if (Route::has('login'))
                                    <li style="margin-top: 30px!important; ">
                                        <a style="font-family: {{ __('web.know_us_font') }}; padding-top: 0px!important; padding-bottom: 0px!important;background-color:#C3BD86!important"
                                            href="{{ route('login') }}"
                                            class="theme-btn btn-style-two">{{ __('web.login') }}
                                        </a>
                                    </li>
                                    <li><a class="nav-img" href="{{ route('register') }}">
                                            <img src="{{ asset('build/assets/images/new-user-white.png') }}"
                                                alt="new-user"title="new-user">
                                        </a>
                                    </li>
                                @endif
                            @else
                                <li style="margin-top: 30px!important; ">
                                    <a style="padding-top: 0px!important; padding-bottom: 0px!important;background-color:#1f2d51!important"
                                        href=""
                                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                        class="theme-btn btn-style-two"
                                        style="font-family: {{ __('web.know_us_font') }};">{{ __('web.logout') }}</a>
                            ...
                            <li>
                                <a class="nav-img"
                                    ...
                                    <img src="{{ asset('build/assets/images/like-white.png') }}" alt=""
                                        title="">
                                </a>
                            </li>
                            <li>
                                <a class="nav-img" href="{{ route('shopping-cart') }}">
                                    <img src="{{ asset('build/assets/images/bag-white.png') }}" alt=""
                                        title="">
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="header-style-two .nav-outer .main-menu">
                        <a style="color: #1F2D51;font-family: {{ __('web.know_us_font_en') }};"
                            href="{{ route('LangConverter', 'en') }}"><img style="width: 20px;"
                                src="{{ asset('build/assets/images/united-kingdom.png') }}" alt="english">
                            English</a>
                        <span>│</span>
                        <a style="color: #1F2D51;font-family: {{ __('web.know_us_font_ar') }};"
    ...
    <nav class="main-menu">
        ...
        <div class="navbar-collapse collapse clearfix mt-4" id="navbarSupportedContent">
            <ul class="navigation clearfix">
                ...
                @else
                    <li><a
                            style="font-family:{{ __('web.know_us_font_ar') }}"href="{{ route('LangConverter', 'ar') }}">العربية
